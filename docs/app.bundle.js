...
var _react = _interopRequireWildcard(__webpack_require__(318));
...
var _paginator = _interopRequireDefault(__webpack_require__(778));

var _Page = _interopRequireDefault(__webpack_require__(865));
...
/******/ 	!function() {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "agorastates:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkagorastates"] = self["webpackChunkagorastates"] || [];
...
;// CONCATENATED MODULE: ./src/images/tab.jpeg
/* harmony default export */ var tab = (__webpack_require__.p + "tab.jpeg");
...
function Form(_ref) {
  ...
  function inputDiscussion() {
    ...
    setDiscussions([newDiscussion].concat(_toConsumableArray(discussions)));
    localStorage.setItem('Discussions', JSON.stringify(discussions));
  }
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: "Form",
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(components_Menubar, {
      text: 'Your Question'
...
function Discussions(_ref) {
  var currentPageData = _ref.currentPageData;
  //스테이트로 받은 페이지 보여주기.
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsx)("ul", {
      ...
      children: currentPageData && currentPageData.map(function (data) {
        return /*#__PURE__*/(0,jsx_runtime.jsxs)("li", {
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            ...
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)("h2", {
              ...
              children: data.author + '/' + new Date(data.createdAt).toLocaleString()
            })]
          }), data.answer !== null ? /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            className: "answered__check",
            children: /*#__PURE__*/(0,jsx_runtime.jsx)("a", {
              href: data.answer.url,
              children: "\uD83D\uDCAC"
            })
          }) : /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            className: "answered__check"
...
;// CONCATENATED MODULE: ./src/components/Paging.js
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || Paging_unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
...
function Paging(_ref) {
  ...
  var discussionsCount = discussions.length;
  var discussionPerPage = 10;
  var totalPage = discussionsCount / discussionPerPage;
  var dataPerPage = [];
  ...
  var pageData = dataPerPage[page - 1];
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: "Paging",
...
;// CONCATENATED MODULE: ./src/components/DiscussionsContainer.js
...
function DiscussionsContainer(_ref) {
  var discussions = _ref.discussions;
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: "DiscussionsContainer",
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(components_Menubar, {
      text: "Question List (".concat(discussions.length, ")")
    }), /*#__PURE__*/(0,jsx_runtime.jsx)(components_Paging, {
      discussions: discussions
    })]
  });
}
/* harmony default export */ var components_DiscussionsContainer = (DiscussionsContainer);
;// CONCATENATED MODULE: ./src/components/Contents.js
function Contents_slicedToArray(arr, i) { return Contents_arrayWithHoles(arr) || Contents_iterableToArrayLimit(arr, i) || Contents_unsupportedIterableToArray(arr, i) || Contents_nonIterableRest(); }
function Contents_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function Contents_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return Contents_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return Contents_arrayLikeToArray(o, minLen); }
function Contents_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function Contents_iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
function Contents_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function Contents() {
  var _useState = (0,react.useState)([]),
    _useState2 = Contents_slicedToArray(_useState, 2),
    storageData = _useState2[0],
    setStorageData = _useState2[1];
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: "Contents",
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(components_Form, {
      discussions: storageData,
      setDiscussions: setStorageData
    }), /*#__PURE__*/(0,jsx_runtime.jsx)(components_DiscussionsContainer, {
      discussions: storageData
    })]
  });
}
/* harmony default export */ var components_Contents = (Contents);
...
function Main() {
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: "Main",
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(components_Tab, {}), /*#__PURE__*/(0,jsx_runtime.jsx)(components_Contents, {})]
  });
}
...
function App() {
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    className: "App",
    children: /*#__PURE__*/(0,jsx_runtime.jsx)(components_Main, {})
  });
}
